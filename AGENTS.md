...
Keep changes local and uncommitted until the user explicitly requests a commit. Record pending changes under `Unreleased` in `CHANGELOG.md`, keeping the published package version unchanged.
